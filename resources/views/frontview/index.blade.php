            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="ltn__tab-menu ltn__tab-menu-2 ltn__tab-menu-top-right-- text-uppercase text-center">
                        <div class="nav">
                            <a class="active show" data-toggle="tab" href="#liton_tab_3_1">BOGO STORE</a>
                            ...
                            <div class="ltn__product-tab-content-inner">
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/11.jpg" alt="#"></a>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{url('detail')}}/#detail">Bogo classic</a></h2>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/7.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/12.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/8.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                            ...
                                            <div class="product-info">
                                                ...
                                                <h2 class="product-title"><a href="{{url('detail')}}/#detail">Bogo Classiv</a></h2>
                                                <div class="product-price">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/13.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/9.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                                    </ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/14.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/10.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/15.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">New</li>
                                                    </ul>
                                        ...
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/6.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
                                                        <li class="sale-badge">-19%</li>
                                                    </ul>
                                                ...
                                                <div class="product-hover-action">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="{{url('public')}}/#whislist" title="Wishlist" data-toggle="modal" data-target="#liton_wishlist_modal">
                                                                <i class="far fa-heart"></i></a>
                                                        </li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="ltn__product-tab-content-inner">
                                <div class="row ltn__tab-product-slider-one-active slick-arrow-1">
                                    ...
                                    <div class="col-lg-12">
                                        <div class="ltn__product-item ltn__product-item-3 text-center">
                                            <div class="product-img">
                                                <a href="{{url('detail')}}/#detail"><img src="{{url('public')}}/img/product/16.jpg" alt="#"></a>
                                                <div class="product-badge">
                                                    <ul>
