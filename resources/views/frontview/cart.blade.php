                ...
                <div class="col-lg-12">
                    <div class="ltn__breadcrumb-inner ltn__breadcrumb-inner-2 justify-content-between">
                        <div class="section-title-area ltn__section-title-2">
                            ...
                            <h1 class="section-title white-color">Checkout barangmu sekarang</h1>
                        </div>
                    ...
                    <div class="shoping-cart-inner">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="cart-product-info">
                                            <h4><a href="product-details.html">Bogo Classic</a></h4>
                                        </td>
                                        <td class="cart-product-price">Rp.140.000,-</td>
                                        <td class="cart-product-quantity">
                                            <div class="cart-plus-minus">
                                                <input type="text" value="02" name="qtybutton" class="cart-plus-minus-box">
                                            </div>
                                        </td>
                                        <td class="cart-product-subtotal">Rp.280.000,-</td>
                                    </tr>
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{url('public')}}/img/product/2.jpg" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                            <h4><a href="product-details.html">Bogo Classic</a></h4>
                                        </td>
                                        <td class="cart-product-price">Rp.100.000,-</td>
                                        <td class="cart-product-quantity">
                                            <div class="cart-plus-minus">
                                                <input type="text" value="02" name="qtybutton" class="cart-plus-minus-box">
                                            </div>
                                        </td>
                                        <td class="cart-product-subtotal">Rp.200.000,-</td>
                                    </tr>
                                    <tr>
                                        <td class="cart-product-remove">x</td>
                                        <td class="cart-product-image">
                                            <a href="product-details.html"><img src="{{url('public')}}/img/product/3.jpg" alt="#"></a>
                                        </td>
                                        <td class="cart-product-info">
                                            <h4><a href="product-details.html">Bogo Classsic</a></h4>
                                        </td>
                                        <td class="cart-product-price">Rp.140.000,-</td>
                                        <td class="cart-product-quantity">
                                            <div class="cart-plus-minus">
                        ...
                        <div class="shoping-cart-total mt-50">
                            ...
                            <div class="btn-wrapper text-right">
                                <a href="{{url('public')}}/#checkout" class="theme-btn-1 btn btn-effect-1">Proceed to checkout</a>
                            </div>
                        </div>
                    </div>
                </div>
