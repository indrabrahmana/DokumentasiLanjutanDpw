                ...
                <div class="row">
                    <div class="col">
                        <div class="site-logo-wrap">
                            <div class="site-logo">
                                <a href="{{url('index')}}/#index"><img src="{{url('public')}}/img/logo-2.png" alt="Logo"></a>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="col-md-6">
                                <div class="ltn__shop-details-img-gallery">
                                    <div class="ltn__shop-details-large-img">
                                        ...
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/2.jpg" data-rel="lightcase:myCollection">
                                                <img src="img/product/2.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/3.jpg" data-rel="lightcase:myCollection">
                                                <img src="img/product/3.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/4.jpg" data-rel="lightcase:myCollection">
                                                <img src="img/product/4.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/5.jpg" data-rel="lightcase:myCollection">
                                                <img src="img/product/5.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/6.jpg" data-rel="lightcase:myCollection">
                                                <img src="img/product/6.jpg" alt="Image">
                                            </a>
                                        </div>
                                        <div class="single-large-img">
                                            <a href="{{url('public')}}/img/product/7.jpg" data-rel="lightcase:myCollection">
                                    ...
                                    <div class="ltn__shop-details-small-img slick-arrow-2">
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/1.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/2.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/3.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/4.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/5.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/6.jpg" alt="Image">
                                        </div>
                                        <div class="single-small-img">
                                            <img src="{{url('public')}}/img/product/7.jpg" alt="Image">
                                        </div>
                                    </div>
                                </div>
                            </div>
